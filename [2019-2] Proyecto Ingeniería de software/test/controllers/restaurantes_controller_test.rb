...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { correo: @restaurante.correo, direccion: @restaurante.direccion, nombre: @restaurante.nombre, numero_telefono: @restaurante.numero_telefono, valoracion: @restaurante.valoracion } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { correo: @restaurante.correo, direccion: @restaurante.direccion, nombre: @restaurante.nombre, numero_telefono: @restaurante.numero_telefono, valoracion: @restaurante.valoracion } }
